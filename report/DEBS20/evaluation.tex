...
Google compares similarly to \gls{AWS} \mais{You mean IBM to AWS, right?}.
Finally, \gls{IBM} \mais{Here should be Google?} consistenly produces  higher cold start latency, in the 2-3 seconds range. 
