...
The cold start latency of 2s--4s makes it unfit for short-lived sessions. %, leading to increased costs \mais{cost should not be higher with cold starts. Clouds only bill when the function is actually running / executing code} especially under heavy workloads.
