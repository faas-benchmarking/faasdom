%!TEX root = main.tex
\section{The Serverless Ecosystem}
This section provides insigghts on the current four main serverless providers, namely Amazon Web Services, Microsoft Azure, Google Cloud and IBM Cloud. 
