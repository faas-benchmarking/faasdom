...
set title "{/bold Execution time of {/Courier-bold faas-fact} (Node.js)}" offset 0,1
...
set key vertical maxrows 1 sample -1 width -3 at screen 0.5,0.68 center font "Arial-Condensed"
