...
We finally present and discuss evaluation results (\S\ref{sec:evaluation}), before concluding with a summary of lessons learned \mais{missing ref to section?} and open perspectives(\S\ref{sec:conclusion}).
