...
\caption{Typical FaaS architecture. The main aspects to benchmark are: general performance of a worker (\emph{i.e.} execution speed of a function) and quality of the auto-scaling mechanism for workers (\emph{i.e.} allocation of new VMs)\vs{MAISSEN: you mean time to allocate/deallocate a new VM?}\label{fig:faas_arch}}
\end{center}
\end{figure}
