...
\caption{Typical FaaS architecture. \mais{OK?} Mainly two of those components need to be benchmarked: general performance of a worker (i.e. execution speed of a function) and the quality of the auto scaling mechanism for workers (i.e. allocation of new VMs).\label{fig:faas_arch}}
\end{center}
\end{figure}
