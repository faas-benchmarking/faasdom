...
\vs{MAISSEN: this component is not in the architecture drawing? if so, where does it fit?}
...
The implementation of \sys is freely available to the open-source community at \url{https://github.com/faasdom/benchmark-suite-serverless-computing}, and it consists of \vs{MAISSEN: FIX} lines of Node.js code.