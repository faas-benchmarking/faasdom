...
Functions can be parametrized with memory allocated, timeouts, list of providers and runtime versions to use for the benchmarks, as well as geographical regions (as supported by the cloud provider) where to deploy the tests. 
%\begin{itemize}
