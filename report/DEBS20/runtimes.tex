...
\textbf{Go}~\cite{GoProject,GoProject}  \mais{2 same references. Did you mean GoDoc also?} is supported by the FaaS providers for two recent releases of the language.
