...
This section dscribes the supported runtimes and respective programming languages supported by the serverless providers described in Section~\ref{sec:background}. 
...
We explain this by the fact the peculiar features of the language make it particulary fit for serverless offerings, as well as its popularity among developers and its productivity advantages.
