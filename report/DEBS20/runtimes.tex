...
Python is similarly well supported, except by Azure with Windows \gls{OS}\vs{MAISSEN: from \ref{table:programming_languages}, this seems not to be totally true}.
