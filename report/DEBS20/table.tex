...
\begin{table*}[!t]
	\caption{Supported runtime systems in serverless computing (\textsuperscript{2}=Azure Functions Generation, \textsuperscript{3}=Azure Functions Generation, \textsuperscript{+}=deprecated, *=beta; \textsuperscript{\#}=only supported in \emph{App Service} or \emph{Premium} plans).}
