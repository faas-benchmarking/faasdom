...
With serverless computing, developers fully delegate to the cloud provider the task of managing the servers, dynamically allocate the required resources, as well as handling availability and fault-tolerance matters.
