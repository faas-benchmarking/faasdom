...
\begin{abstract}
A major trend for cloud providers is serverless computing, where the responsibility of managing servers, allocation of resources, scaling and availability lies with the provider and not the user. \mais{Ok?}.
Despite this increasing popularity, there is little data regarding the actual performances of the available platforms.
Specifically, it is difficult to test and benchmark such systems in an independent manner.
Practitioners and researchers are obliged to deploy their systems to take informed decisions regarding the most convenient solution, both in terms of performance and costs.
